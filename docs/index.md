此文档仅适用于 Chrm Rev v1.1.0

此文档写于 2026年4月，请结合实际情况参考。

开发：mcitem

作者邮箱：mcitem@qq.com

开源地址: https://github.com/mcitem/chrm-rev

---

## 下载

`fixed-webview2` 嵌入WebView2 运行时版本

`skip-webview2` 不带运行时的版本，需要系统已安装Webview环境

`i686-win7-windows-msvc` Windows7专用版本

`stable_x86_64-pc-windows-msvc` Windows10、11 64位版本

<table>
  <tbody align="center">
    <tr>
      <th rowspan="2" colspan="2">下载地址</th>
      <th colspan="2">Windows7</th>
      <th>Windows10/11</th>
    </tr>
    <tr>
      <td>带运行时</td>
